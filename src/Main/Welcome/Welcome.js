...
const Welcome = (props) => {
    return (
        <WelcomeDiv>
            ...
            <h6>
                <span id="skills-show">Skills <i className="fa fa-chevron-circle-right" aria-hidden="true"></i></span>
                <span id="skills-span" className="hide">
            ...
            <h6>
              <span id="hobbies-show">On the side...<i className="fa fa-chevron-circle-right" aria-hidden="true"></i></span>
              <span id="hobby-text" className="hide">
                I love being a home cook, hiking, traveling, and finding delicious beers!
                <i id="hobbies-hide" className="fa fa-chevron-circle-left" aria-hidden="true"></i>
              </span>
            </h6>
        </WelcomeDiv>
    );
